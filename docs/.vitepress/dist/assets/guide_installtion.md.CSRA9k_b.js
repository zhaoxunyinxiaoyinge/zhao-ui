import{_ as a,c as o,o as e,a2 as l}from"./chunks/framework.BEBgH-zq.js";const m=JSON.parse('{"title":"安装指南","description":"","frontmatter":{},"headers":[],"relativePath":"guide/installtion.md","filePath":"guide/installtion.md","lastUpdated":null}'),s={name:"guide/installtion.md"};function i(n,t,c,r,p,u){return e(),o("div",null,t[0]||(t[0]=[l(`<h1 id="安装指南" tabindex="-1">安装指南 <a class="header-anchor" href="#安装指南" aria-label="Permalink to &quot;安装指南&quot;">​</a></h1><h2 id="安装包管理器" tabindex="-1">安装包管理器 <a class="header-anchor" href="#安装包管理器" aria-label="Permalink to &quot;安装包管理器&quot;">​</a></h2><div class="tip custom-block"><p class="custom-block-title">1. npm install zhao-ui --save</p></div><div class="tip custom-block"><p class="custom-block-title">2. pnpm install zhao-ui --save</p></div><h3 id="使用步骤" tabindex="-1">使用步骤 <a class="header-anchor" href="#使用步骤" aria-label="Permalink to &quot;使用步骤&quot;">​</a></h3><div class="tip custom-block"><p class="custom-block-title">TIP</p><pre><code>1. 使用方法:
  ...
  &lt;head&gt;
    ...
    &lt;/head&gt;
\`\`\`
</code></pre></div>`,8)]))}const h=a(s,[["render",i]]);export{m as __pageData,h as default};
